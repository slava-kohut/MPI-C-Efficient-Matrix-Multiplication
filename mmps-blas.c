...
double A[M][N], b[N][K], c[M][K], ans[K], *buff, alpha, beta; 
...
// SLAVES
 ...
 /*
  * BLAS call using the CBLAS interface
  */

  cblas_dgemm(CblasRowMajor,CblasNoTrans,CblasNoTrans,1,K,N,alpha,buff,N,b,K,beta,ans,K); 
